...
import com.veteran.hack.gui.rgui.component.AbstractComponent;
...
import com.veteran.hack.gui.rgui.component.listen.TickListener;
...
import com.veteran.hack.gui.kami.component.ActiveModules;
...
import com.veteran.hack.gui.rgui.component.use.CheckButton.CheckButtonPoof;
import com.veteran.hack.gui.rgui.component.listen.MouseListener;
...
import com.veteran.hack.util.Pair;
import com.veteran.hack.module.Module;
import java.util.HashMap;
import com.veteran.hack.gui.kami.theme.kami.KamiTheme;
...
import com.veteran.hack.gui.rgui.GUI;

public class KamiGUI extends GUI
{
    public static final CFontRenderer cFontrenderer;
    ...
    public void initializeGUI() {
        ...
        final Label pvpview = new Label("");
        pvpview.setShadow(false);
        final AbstractComponent abstractComponent2;
        pvpview.addTickListener(() -> {
            abstractComponent2.setWidth(60);
            abstractComponent2.setHeight(100);
            return;
        });
        frame2.addChild(pvpview);
        playerv.setFontRenderer(KamiGUI.fontRenderer);
        frames.add(frame2);
        frame2 = new Frame(this.getTheme(), new Stretcherlayout(1), "Hole HUD");
        frame2.setCloseable(false);
        frame2.setMinimizeable(true);
        frame2.setPinnable(true);
        frame2.setWidth(100);
        frame2.setHeight(100);
        final Label hole = new Label("");
        hole.setShadow(false);
        final AbstractComponent abstractComponent3;
        hole.addTickListener(() -> {
            abstractComponent3.setWidth(60);
            abstractComponent3.setHeight(60);
            return;
        });
        frame2.addChild(hole);
        playerv.setFontRenderer(KamiGUI.fontRenderer);
        frames.add(frame2);
        ...
        final AbstractComponent abstractComponent4;
        inventory.addTickListener(() -> {
            abstractComponent4.setWidth(151);
            abstractComponent4.setHeight(40);
            abstractComponent4.setOpacity(0.1f);
            return;
        });
    ...
    static {
        cFontrenderer = new CFontRenderer(new Font("Arial", 0, 18), false, false);
