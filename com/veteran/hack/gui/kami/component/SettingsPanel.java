...
import com.veteran.hack.setting.impl.numerical.DoubleSetting;
import com.veteran.hack.setting.impl.numerical.FloatSetting;
import com.veteran.hack.gui.rgui.component.use.Slider.SliderPoof;
import com.veteran.hack.gui.rgui.component.use.Slider;
import com.veteran.hack.setting.impl.numerical.IntegerSetting;
...
import com.veteran.hack.setting.impl.numerical.NumberSetting;
...
import com.veteran.hack.gui.rgui.component.container.OrganisedContainer;
...
public class SettingsPanel extends OrganisedContainer
{
    ...
    public static String getModuleAsString(final String name) {
        return EntityUseTotem.encrypt(name, "D(G+KbPeSgVkYp3s6v9y$B&E)H@McQfTjWmZq4t7w!z%C*F-JaNdRgUkXp2r5u8x");
    }
}
