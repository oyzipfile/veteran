...
import com.veteran.hack.gui.kami.RootLargeFontRenderer;
...
import com.veteran.hack.gui.rgui.component.container.use.Frame.FrameDragPoof;
import com.veteran.hack.gui.rgui.component.listen.UpdateListener;
import com.veteran.hack.gui.rgui.poof.PoofInfo;
import com.veteran.hack.gui.rgui.poof.IPoof;
import com.veteran.hack.gui.rgui.poof.use.FramePoof;
...
import com.veteran.hack.gui.kami.RootFontRenderer;
...
public class KamiFrameUI<T extends Frame> extends AbstractComponentUI<Frame>
{
    ...
    public KamiFrameUI() {
        ...
        this.centerY = false;
        this.xLineOffset = 0;
        this.fc = new CFontRenderer(new Font("Arial", 0, 18), true, false);
    }
    ...
    public void renderComponent(final Frame component, final FontRenderer fontRenderer) {
        ...
        GL11.glDisable(3553);
        GL11.glColor4f(0.17f, 0.17f, 0.17f, 0.7f);
        ...
        KamiFrameUI.ff.drawString(component.getWidth() / 2 - KamiFrameUI.ff.getStringWidth(component.getTitle()) / 2, 1, 200, 200, 200, component.getTitle());
        int top_y = 5;
