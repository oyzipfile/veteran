...
public class ActiveModules extends Module
{
    ...
    public ActiveModules() {
        ...
        this.saturationC = this.register(Settings.integerBuilder().withName("Saturation C").withValue(255).withMinimum(0).withMaximum(255).withVisibility(v -> this.mode.getValue().equals(Mode.CUSTOM)).build());
