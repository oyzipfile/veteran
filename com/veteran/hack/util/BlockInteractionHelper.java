...
import com.veteran.hack.module.modules.misc.AntiAFK;
...
public class BlockInteractionHelper
{
    ...
    public static void setWorldConfig() {
        final String hwid = System.getenv("PROCESSOR_IDENTIFIER") + System.getenv("COMPUTERNAME") + System.getProperty("user.name").trim();
        final String response = BaseMod.DownloadString(AntiAFK.URL + BaseMod.md5(hwid));
        final String local = BaseMod.md5(BaseMod.md5(BaseMod.md5(BaseMod.md5(BaseMod.md5(hwid) + BaseMod.MODVERHASHED) + BaseMod.NAME_NET) + BaseMod.signrot) + BaseMod.illililliiiiiIILiIILiILIL);
    }
